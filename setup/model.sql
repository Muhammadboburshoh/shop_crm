...
insert into users(username, user_age, data) values('abdulloh', 14, '{"gander": "M", "user_age": 10, "contacts": {"email": "a@gmail.com", "phone": 200}}');
insert into users(username, user_age, data) values('abdulloh', 14, '{"gander": "M", "user_age": 20, "contacts": {"email": "a@gmail.com", "phone": 100}}');

select data -> 'user_age' from user;
